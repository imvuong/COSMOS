...
require 'cosmos'
require 'cosmos/tools/gm_cmd_tlm_server/cmd_tlm_server'
require 'cosmos/tools/gm_cmd_tlm_server/gui/interfaces_tab'
require 'cosmos/tools/gm_cmd_tlm_server/gui/targets_tab'
require 'cosmos/tools/gm_cmd_tlm_server/gui/packets_tab'
require 'cosmos/tools/gm_cmd_tlm_server/gui/logging_tab'
require 'cosmos/tools/gm_cmd_tlm_server/gui/status_tab'
    ...
    def handle_string_output
      if @string_output.string[-1..-1] == "\n"
        Qt.execute_in_main_thread(true) do
          ...
          string.each_line{|out_line|

            out_line.gsub!(' ','_')
            out_line.gsub!('<','{')
            out_line.gsub!('>','}')
            out_line = out_line[25..-1]

            0
            message = "<MESSAGE SUBJECT=\"GMSEC.COSMOS.CMD-TLM-SERVER\" KIND=\"PUBLISH\">\n<FIELD TYPE=\"STRING\" NAME=\"COMPONENT\">COSMOS</FIELD>\n<FIELD TYPE=\"STRING\" NAME=\"FACILITY\">NASA-GSFC</FIELD>\n<FIELD TYPE=\"STRING\" NAME=\"MESSAGE-TYPE\">SERVER-INFO</FIELD>\n<FIELD TYPE=\"STRING\" NAME=\"MSG\">#{out_line}</FIELD>\n</MESSAGE>"
