...
require '/Users/mwalker8/COSMOS/rbtest.rb'
require 'cosmos'
require 'cosmos/gui/qt'
require 'cosmos/gui/qt_tool'
require 'cosmos/script'
require 'cosmos/tools/gm_tlm_viewer/widgets'
    ...
    class Widgets
      ...
      def update_gui
        begin
          ...
          String message = "<MESSAGE SUBJECT=\"GMSEC.COSMOS.TLM_VIEWER\" KIND=\"PUBLISH\">\n<FIELD TYPE=\"STRING\" NAME=\"COMPONENT\">COSMOS</FIELD>\n<FIELD TYPE=\"STRING\" NAME=\"FACILITY\">NASA-GSFC</FIELD>\n<FIELD TYPE=\"STRING\" NAME=\"MESSAGE-TYPE\">TELEMETRY-DATA</FIELD>\n<FIELD TYPE=\"STRING\" NAME=\"INSTRUMENT\">#{@items[0][0]}</FIELD>\n" # @ Mike Walker
          String temp = ''
          ...
          if @alive
            ...
            @mutex.synchronize do
              (0..(@values.length - 1)).each do |index|
                ...
                temp = "<FIELD TYPE=\"STRING\" NAME=\"#{@items[index][0]}-#{@items[index][1]}-#{@items[index][2]}\">#{item[index].value}</FIELD>\n" # @ Mike Walker

                message = "#{message}#{temp}"
              end
              message = "#{message}</MESSAGE>" # @ Mike Walker

              #`java -Djava.library.path=/Users/mwalker8/GMSEC/GMSEC_API/bin -cp /Users/mwalker8/GMSEC/GMSEC_API/bin/gmsecapi.jar:/Users/mwalker8/GMSEC/GMSEC_API/examples/java gmpub connectiontype=gmsec_bolt message='#{message}'`


#              output = `java -Djava.library.path=/Users/mwalker8/GMSEC/GMSEC_API/bin -cp /Users/mwalker8/GMSEC/GMSEC_API/bin/gmsecapi.jar:/Users/mwalker8/GMSEC/GMSEC_API/examples/java gmpub connectiontype=gmsec_bolt message='<MESSAGE SUBJECT="GMSEC.TEST.COSMOS.TLM" KIND="PUBLISH"><FIELD TYPE="BIN" NAME="BIN-FIELD">4A4C4D4E4F5051</FIELD><FIELD TYPE="BOOL" NAME="BOOL-FIELD-FALSE">FALSE</FIELD><FIELD TYPE="BOOL" NAME="BOOL-FIELD-TRUE">TRUE</FIELD><FIELD TYPE="CHAR" NAME="CHAR-FIELD">c</FIELD><FIELD TYPE="I32" NAME="COUNT">0</FIELD><FIELD TYPE="F32" NAME="F32-FIELD" BITS="40000000">2</FIELD><FIELD TYPE="F64" NAME="F64-FIELD" BITS="4000000000000000">2</FIELD><FIELD TYPE="I16" NAME="I16-FIELD">1</FIELD><FIELD TYPE="I32" NAME="I32-FIELD">1</FIELD><FIELD TYPE="I64" NAME="I64-FIELD">1</FIELD><FIELD TYPE="I8" NAME="I8-FIELD">1</FIELD><FIELD TYPE="STRING" NAME="STRING-FIELD">This is a test</FIELD><FIELD TYPE="U16" NAME="U16-FIELD">1</FIELD><FIELD TYPE="U32" NAME="U32-FIELD">1</FIELD><FIELD TYPE="U64" NAME="U64-FIELD">1</FIELD><FIELD TYPE="U8" NAME="U8-FIELD">1</FIELD><FIELD TYPE="STRING" NAME="COMPONENT">COSMOS</FIELD><FIELD TYPE="STRING" NAME="FACILITY">GSFC</FIELD></MESSAGE>'`
              output = `export DYLD_LIBRARY_PATH=/Users/mwalker8/GMSEC/GMSEC_API/bin && /usr/bin/java -Djava.library.path=/Users/mwalker8/GMSEC/GMSEC_API/bin -cp /Users/mwalker8/GMSEC/GMSEC_API/bin/gmsecapi.jar:/Users/mwalker8/GMSEC/GMSEC_API/examples/java gmpub connectiontype=gmsec_bolt message='#{message}'`
